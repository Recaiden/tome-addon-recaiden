...
version = {1,7,0}
addon_version = {1,0,0}
weight = 54 -- The lower this value, the sooner your addon will load compared to other addons.
author = {"Recaiden"}
homepage = ''
...
tags = {'interface','item','description','improve','tooltip'} -- tags MUST immediately follow description
