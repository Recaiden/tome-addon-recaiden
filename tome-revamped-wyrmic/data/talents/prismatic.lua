...
newTalent{
  ...
  getResistPen = function(self, t) return self:combatTalentLimit(t, 60, 10, 35) end,
  info = function(self, t)
...
Whenever you change aspect, the cooldowns of Dragon's Breath and Overwhelm will be reduced by %d.]]):format(t.getDamageIncrease(self, t), t.getResistPen(self, t), t.CDreduce(self, t))
  end,
}
