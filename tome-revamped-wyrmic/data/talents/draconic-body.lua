...
newTalent{
	...
	info = function(self, t)
		...
		return ([[Your mind is as strong and resilient as that of a great wyrm, allowing you to shrug off difficulties that would stop a lesser creature in its tracks.  Reduce the duration of up to %d detrimental effects by %d turns.
