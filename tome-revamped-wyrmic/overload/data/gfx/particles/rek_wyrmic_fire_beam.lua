...
return { generator = function()
	...
	return {
		...
		dir = rng.percent(50) and ray.dir + math.rad(90) or ray.dir - math.rad(90), dirv = rng.float(-0.1,0.1), dira = 0,
		vel = rng.percent(80) and 1 or 0, velv = -0.2, vela = 0.01,

		r = rng.float(0.9,1), rv = 0, ra = 0,
		g = rng.float(0.8,0.9), gv = -0.04, ga = 0,
		b = 0, bv = 0, ba = 0,
