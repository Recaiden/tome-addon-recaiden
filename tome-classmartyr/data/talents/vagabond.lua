...
newTalent{
	...
	info = function(self, t)
		return ([[You make unusual modifications to your sling bullets, causing them to inflict a stacking 10%% movement speed slow (#SLATE#no save#LAST#) that deal %0.2f mind damage per stack. This counts as a disease (but ignores immunity).  If the target breaks free from the slow, they'll be immune to it for the next five turns. 
