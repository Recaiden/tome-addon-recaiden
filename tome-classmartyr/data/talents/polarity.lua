newTalent{
   ...
   info = function(self, t)
      return ([[You learn to intensify chaotic forces to your advantage, giving you a 'minimum insanity' for determining random insane effects.
...
newTalent{
	...
	getMaxSteps = function(self, t) return math.max(t.getMinSteps(self, t) + 1, math.floor(self:combatTalentScale(t, 6, 8.5)))  end,
