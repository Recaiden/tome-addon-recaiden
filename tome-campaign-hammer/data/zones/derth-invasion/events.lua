...
return { one_per_level=true,
	...
	{name="orcs+AAA", minor=true, percent=65},
	{name="glowing-chest", minor=true, percent=30},
	{name="thunderstorm", percent=15},
	{name="orcs+herbs", minor=true, percent=100},
	{name="orcs+drills", minor=true, percent=8000, max_repeat=8},
}
