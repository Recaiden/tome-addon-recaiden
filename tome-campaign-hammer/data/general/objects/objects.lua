...
loadIfNot("/data-orcs/general/objects/generic.lua")

-- Lore
loadIfNot("/data-orcs/general/objects/lore.lua")

-- Artifacts
loadIfNot("/data/general/objects/world-artifacts-far-east.lua")
loadIfNot("/data/general/objects/boss-artifacts-far-east.lua")

loadIfNot("/data-orcs/general/objects/world-artifacts.lua")
loadIfNot("/data-orcs/general/objects/boss-artifacts.lua")