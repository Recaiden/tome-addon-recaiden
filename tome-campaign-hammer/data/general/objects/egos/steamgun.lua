...
newEntity{
	power_source = {technique=true},
	name = " of true shot", suffix=true, instant_resolve=true,
	keywords = {trueshot=true},
	level_range = {30, 50},
	greater_ego = 1,
	rarity = 20,
	cost = 40,
...
newEntity{
	...
	wielder = {
		inc_damage={ [DamageType.BLIGHT] = resolvers.mbonus_material(14, 8), },
	},
}
...
newEntity{
	...
	combat = {
		talent_on_hit = { [Talents.T_OVERGROWTH] = {level=2, chance=10} },
	},
}
