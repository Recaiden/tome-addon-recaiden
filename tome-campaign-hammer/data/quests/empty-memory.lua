...
desc = function(self, who)
   ...
   desc[#desc+1] = "But it didn't have any memories in it.\n"
	 if self:isStatus(self.DONE) then desc[#desc+1] = "#LIGHT_GREEN#* Oh.  The memory crystal is empty *now*, but it was full when you got it.  You just couldn't remember#WHITE#" end
