...
local function regenerateChat()
	...
	for tid, _ in pairs(src.talents_cd) do
		...
		if t and not t.is_inscription and not t.generic and not t.uber and not (t.mode and t.mode == "passive") and not t.fixed_cooldown and src.talents_cd[tid] ~= 0 then
