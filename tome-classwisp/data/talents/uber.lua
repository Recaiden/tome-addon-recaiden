...
newTalent{
	...
	require = {
		...
		special={
			...
			fct=function(self)
				return self:getTalentLevelRaw(self.T_REK_GLR_ARROWSTORM_KALMANKA) + self:getTalentLevelRaw(self.T_REK_GLR_ARROWSTORM_VITARIS) + self:getTalentLevelRaw(self.T_REK_GLR_ARROWSTORM_PELLEGRINA) + self:getTalentLevelRaw(self.T_FOCUS_REK_GLR_ARROWSTORM_KAMILLA) >= 10
			end
		}
	},
