...
newTalent{
	...
	info = function(self, t)
		local damage = t.getDamage(self, t)
		return ([[Drawing on your deep insight into solar mysteries, you create a powerful 3-wide beam of radiance.	The beam deals %0.2f light damage, stuns enemies for 3 turns, and always goes as far as possible.
