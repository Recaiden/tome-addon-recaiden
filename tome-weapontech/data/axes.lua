...
newTalent{
	...
	getBleedDamage = function(self, t) return self:combatTalentWeaponDamage(t, 0.8, 0.8) end,
	action = function(self, t)
		...
		if hit and target:canBe("cut") then
			...
			target:setEffect(target.EFF_CUT, 3, {src=self, power=dam / 3, apply_power=self:combatAttack()})
		end
		return true
	end,
...
newTalent{
	name = "Shieldshatter", short_name = "REK_WTEK_AXE_POMMEL STRIKE",
