newTalent{
	...
	type = {"undead/shadow-destruction", 1}, require = undeads_req1, points = 5,
	hate = 2,
	cooldown = 3,
...
newTalent{
	...
	type = {"undead/shadow-destruction",2}, require = undeads_req2, points = 5,
	hate = 3,
	cooldown = 3,
...
Mindpower: increases damage]]):tformat(damDesc(self, DamageType.LIGHTNING, damage / 3),
...
newTalent{
	...
	type = {"undead/shadow-destruction", 3}, require = undeads_req3, points = 5,
	...
	info = function(self, t)
		...
		This talent will also attack with your shield, if you have one equipped.]]):tformat(duration, -armorChange, -defenseChange)
   end,
}

newTalent{
	name = "Shadow of Speed", short_name = "REK_HOLLOW_SHADOW_BLINDSIDE",
	type = {"undead/shadow-destruction",4}, require = undeads_req4, points = 5,
...
Dexterity: improves damage reduction]]):tformat(self:getTalentRange(t), multiplier * 100, t.getDefenseChange(self, t))
	end,
}
