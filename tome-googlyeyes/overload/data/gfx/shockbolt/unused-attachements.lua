...
tiles["npc/humanoid_halfling_agrimley_the_hermit.png"] = { base = 64
  head = {x=, y=},
}
...
tiles["npc/humanoid_naga_lady_nashva_the_streambender.png"] = { base = 64
  head = {x=, y=},
}
...
-- default is fine
tiles["npc/vermin_oozes_black_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_bloated_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_blue_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_brittle_clear_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_crimson_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_gelatinous_cube.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_green_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_morphic_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_poison_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_red_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_slimy_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_white_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/vermin_oozes_yellow_ooze.png"] = { base = 64
  head = {x=, y=},
}
tiles["npc/undead_shadow_shadow.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/undead_horror_bone_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/undead_horror_boney_experiment.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/undead_horror_fleshy_experiment.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/undead_horror_necrotic_abomination.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/undead_horror_necrotic_mass.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/undead_horror_sanguine_experiment.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/undead_horror_sanguine_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/undead_ghost_will_o__the_wisp.png"] = { base = 64,
  head = {x=, y=},
}

tiles["npc/trap_bladestorm_swish_01.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/trap_bladestorm_swish_02.png"] = { base = 64,
  head = {x=, y=},
}

tiles["npc/spellblaze_crystal.png"] = { base = 64,
  head = {x=, y=},
}

tiles["npc/jelly-blue.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/jelly-darkgrey.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/jelly-green.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/jelly-red.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/jelly-white.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/jelly-yellow.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/immovable_crystal_golden_crystal.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/immovable_jelly_malevolent_dimensional_jelly.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/immovable_molds_brown_mold.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/immovable_molds_green_mold.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/immovable_molds_grey_mold.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/immovable_molds_shining_mold.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/immovable_molds_skeletal_mold.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/crystal_black.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/crystal_blue.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/crystal_darkred.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/crystal_npc.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/crystal_red.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/crystal_violet.png"] = { base = 64,
  head = {x=, y=},
}

tiles["npc/arcane_eye.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/vermin_worms_green_worm_mass.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/vermin_worms_white_worm_mass.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/demon_major_daelach.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/horror_eldritch_dream_seed.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_light_wisp.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_air_greater_gwelgoroth.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_air_gwelgoroth.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_air_ultimate_gwelgoroth.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_losgoroth_space_disturbance.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_temporal_epoch.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_temporal_greater_telugoroth.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_temporal_greater_teluvorta.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_temporal_telugoroth.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_temporal_teluvorta.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_temporal_ultimate_telugoroth.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/elemental_temporal_ultimate_teluvorta.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/giant_ogre_degenerated_ogric_mass.png"] = { base = 64,
  head = {x=, y=},
}


tiles["npc/horror_aquatic_abyssal_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/horror_aquatic_boiling_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/horror_aquatic_entrenched_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/horror_eldritch_dreaming_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/horror_aquatic_swarm_hive.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/horror_eldritch_oozing_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/horror_temporal_void_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/dream_seed.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/seed_of_dreams.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/shadow-caster.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/shadow-claw.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/shadow-stalker.png"] = { base = 64,
  head = {x=, y=},
}
tiles["construct_mechanical_ancient_automated_archive.png"] = { base = 64,
  head = {x=31, y=19},
}
...
tiles["npc/horror_aquatic_swarming_horror.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/hornet_swarm.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/hostile_humanoid_adventurers_party.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/hostile_humanoid_ziguranth_patrol.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/bee_swarm.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/midge_swarm.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/patrol_allied_kingdoms_allied_kingdoms_halfling_patrol.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/patrol_allied_kingdoms_allied_kingdoms_human_patrol.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/patrol_orc_pride_orcs_patrol.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/patrol_sunwall_anorithil_patrol.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/patrol_sunwall_sun_paladins_patrol.png"] = { base = 64,
  head = {x=, y=},
}

--8 eyes
tiles["npc/spiderkin_shiaak_shiaak_venomblade.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_chitinous_spider.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_faerlhing.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_fate_spinner.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_fate_weaver.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_gaeramarth.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_giant_spider.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_losselhing.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_nimisil.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_ninandra_the_great_weaver.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_ninurlhing.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_orb_spinner.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_orb_weaver.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_spitting_spider.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_ungole.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_ungolmor.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_weaver_matriarch.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_weaver_patriarch.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_weaver_queen.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_spider_weaver_young.png"] = { base = 64,
  head = {x=, y=},
}
tiles["npc/spiderkin_xhaiak_xhaiak_arachnomancer.png"] = { base = 64,
  head = {x=, y=},
}
