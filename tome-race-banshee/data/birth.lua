...
--     return profile.mod.allow_build.undead_banshee
  ...
  cosmetic_options = {
     skin = {
        {name="Pale Skin ", file="base_01"},
        {name="Pink Skin", file="base_02"},
        {name="Tanned Skin", file="base_03"},
        {name="White Skin", file="base_04"},
        {name="Yellow Skin", file="base_05"},
        {name="Dark Skin", file="base_06"},
        {name="Brown Skin", file="base_07"},
        {name="Black Skin", file="base_08"},
